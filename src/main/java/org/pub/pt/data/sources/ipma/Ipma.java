...
import org.pub.pt.data.sources.ipma.domain.BaseInfo;
import org.pub.pt.data.sources.ipma.domain.BeachEntry;
import org.pub.pt.data.sources.ipma.domain.GeoWeather;
import org.pub.pt.data.sources.ipma.domain.Land;
import org.pub.pt.data.sources.ipma.domain.LandWeather;
import org.pub.pt.data.sources.ipma.domain.Sea;
import org.pub.pt.data.sources.ipma.domain.SeaWeather;
import org.pub.pt.data.sources.ipma.domain.Uv;
import org.pub.pt.data.sources.ipma.domain.UvWeather;
...
public class Ipma {
	...
	public List<GeoWeather<?>> getForecastDay(int dayNumber) throws Exception{
		...
		Connection seac=DomUtils.getHTML(String.format(FORECAST_DAY_PATTERN,dayNumber));
		Document doc=seac
	...
	public List<TableData> getSeismicActivity(Date date) throws Exception{
		...
		Connection con=DomUtils.getHTML(SYSMOLOGY_URL);
