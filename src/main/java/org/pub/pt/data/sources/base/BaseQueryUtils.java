package org.pub.pt.data.sources.base;
...
public class BaseQueryUtils {
    ...
    public static final String SUB_QUERY_PATTERN = "texto=%s&tipo=%s&tipocontrato=%s"
            + "&cvp=%s&numeroanuncio=%s&aqinfo=%s&adjudicante=%s&adjudicataria=%s"
    ...
    public static String queryFull(
            ...
            int tipoContracto, String cvp, String numanuncio, String aqinfo, String adjudicante,
        ...
        String query = String.format(SUB_QUERY_PATTERN,
                text, type2, tipoContracto, cvp, numanuncio, aqinfo, adjudicante, adjudicaria, desdePrecoContractoFalse,
        ...
        return String.format(QUERY_PATTERN,
                pageStart, pageEnd, type, query, "UTF-8"
        );
    }
